...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    ...
    <title>Graduate / Diploma Survay Report - by Stream</title>
...
<table width="1200px" height="60px" cellpadding="0px" cellspacing="0px"  id="results"  >
    <tr width='1200px' height='30px'>
        <td  align="center" style=" font-weight:bold;  font-size:16px; font-family:"Arial Narrow"">
            Provincial Overall Summery - by Stream
        </td>
    </tr>
</table>
<table width="120px" height="60px" cellpadding="0px" cellspacing="1px"  id="report_bystream"  style="border: solid 1px; width: 25%" >
<thead style="font-size:1em">	
<tr width='120px' height='25px'   bgcolor='#EBEBEB'>
    <td width='60px' height='25px'  align='center' class='Viso2' style="border-bottom:solid 1px; border-right:solid 1px">Stream</td>
...
<tr width='120px' height='25px'   bgcolor='#EBEBEB'>
    <td width='60px' height='25px'  align='center' class='Viso2' style="border-bottom:solid 1px; border-right:solid 1px"> {{$data['str_name']}} </td>
