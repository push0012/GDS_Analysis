...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    ...
    <title>Graduate / Diploma Survay Report - by Degree Speciality</title>
...
<table width="1200px" height="60px" cellpadding="0px" cellspacing="0px"  id="results"  >
    <tr width='1200px' height='30px'>
        <td  align="center" style=" font-weight:bold;  font-size:16px; font-family:"Arial Narrow"">
            Provincial Overall Summery - by Degree Speciality
        </td>
    </tr>
</table>
<table width="120px" height="60px" cellpadding="0px" cellspacing="1px"  id="report_byspeciality"  style="border: solid 1px; width: 25%" >
...
<tr width='120px' height='25px'   bgcolor='#EBEBEB'>
    <td width='60px' height='25px'  align='center' class='Viso2' style="border-bottom:solid 1px; border-right:solid 1px"> {{$data['speciality']}} </td>
