...
@section('content')
  <div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('profile.create') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Insert User') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-new_password">{{ __('Password') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('new_password') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('new_password') ? ' is-invalid' : '' }}" input type="password" name="new_password" id="new_password" placeholder="{{ __('Password') }}" value="" required />
